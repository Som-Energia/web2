<?php
function apollo13_shortcode_post_teaser($atts, $content = null, $code) {
    ...
    $el_class = a13_sc_getExtraClass( $el_class );
    ...
    $code_type = substr($code, 11); //prefix: a13_recent_{$code_type}
    $post_type = '';
    $taxonomies = array();
    ...
    elseif($code_type === 'works'){
        $post_type = 'work';
        array_push($taxonomies, 'genre');
    }
    elseif($code_type === 'galleries'){
        $post_type = 'gallery';
...
add_shortcode('a13_recent_posts', 'apollo13_shortcode_post_teaser');
add_shortcode('a13_recent_works', 'apollo13_shortcode_post_teaser');
add_shortcode('a13_recent_galleries', 'apollo13_shortcode_post_teaser');